...
class PrzygotowanieDoAplikacjiType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('lepkoscStomerMIN','integer',array('required'=>false))
            ->add('lepkoscStomerMAX','integer',array('required'=>false))
            ->add('lepkoscFordMIN','integer',array('required'=>false))
            ->add('lepkoscFordMAX','integer',array('required'=>false))
            ->add('zalecanaGruboscPowlokiSucho','integer',array('required'=>false))
            ->add('zalecanaGruboscPowlokiMokro','integer',array('required'=>false))
            ->add('nominalnaGruboscPowlokiSucho','integer',array('required'=>false))
            ->add('nominalnaGruboscPowlokiMokro','integer',array('required'=>false))
            ->add('punktRosy')
        ;
    }
